...
class OfficeTest {
    ...
    void getNames() {
        ...
        names.addAll(List.of("Tárgyaló", "Aula", "Kistárgyaló", "Előadó", "Vizsgaterem"));
    ...
    void getNamesReverse() {
        List<String> names = new ArrayList<>();
        names.addAll(List.of("Vizsgaterem", "Előadó", "Kistárgyaló", "Aula", "Tárgyaló"));
    ...
    void getEvenNames() {
        List<String> names = new ArrayList<>();
        names.addAll(List.of("Tárgyaló", "Kistárgyaló", "Vizsgaterem"));
    ...
    void getAreas() {
        ...
        areas.addAll(List.of(15*20, 20*20, 3*5, 15*32, 10*20));
    ...
    void getAreas_wrong() {
        List<Integer> areas = new ArrayList<>();
        areas.addAll(List.of(15*20+1, 20*20-2, 3*5-3, 15*32*0, 10*20-2));
        for(int i = 0; i< areas.size(); i++){
